...
<html lang="en">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Login/Cadastro<i class="ion-ios-arrow-forward"></i></a></span> <span>Cadastro <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Cadastro</h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <span class="subheading">Cadastro</span>
            <h2 class="mb-2">Cadastramento de Cliente</h2>
          </div>
        </div>
 <form method="post" action="valida_cliente.php">
  <div class="form-row">
      ...
      <input type="name" name="nome" class="form-control" id="inputEmail4" placeholder="Insira seu Nome">
    </div>
    <div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
    ...
    <div class="form-check">
      ...
      <label class="form-check-label" for="gridCheck">
        Eu aceito os termos de Privacidade<br>
      </label>
    </div>
